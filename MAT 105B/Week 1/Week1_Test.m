...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fncs={'myFirstFunc','lagrangePoly','newtonDivDiff'};
firstCodingAssngm = 1;
testOrGrade = 'test';
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
results=zeros(max(size(classIDS)),length(fncs));
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if currentFunc == 2
            if abs(feval(string(append(fncs(currentFunc),'_',stdID)),[2;2.75;4],1./[2;2.75;4],3)-0.32955)<10^(-4)
                results(currentStudent,currentFunc+1)=1;
            else
                results(currentStudent,currentFunc+1)=0;
            end
        ...
        if currentFunc == 3
            if norm(feval(string(append(fncs(currentFunc),'_',stdID)),[1.0;1.3;1.6;1.9;2.2],[0.7651977;0.6200860;0.4554022;0.2818186;0.1103623])-[0.7651977;-0.4837057;-0.1087339;0.0658784;0.0018251],2)<10^(-4)
                results(currentStudent,currentFunc+1)=1;
            else
                results(currentStudent,currentFunc+1)=0;
            end
