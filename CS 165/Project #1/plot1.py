...
if __name__ == '__main__':
    ...
    plt.title('Elapsed Time vs. Input Size (insertion_sort / merge_sort - random)')
    plt.xlabel('Input Size (n # elements)')
    plt.ylabel('Elapsed Time (nanoseconds)')

    fit1 = "is1: " + str(add_to_plot('insertion_sort',PermutationType.UNIFORMLY_DISTRIBUTED,1))
    fit2 = "ms2: " + str(add_to_plot('merge_sort',PermutationType.UNIFORMLY_DISTRIBUTED,3))

    plt.legend([fit1,fit2])
