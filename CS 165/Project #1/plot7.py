...
if __name__ == '__main__':
    ...
    plt.title('Elapsed Time vs. Input Size (shell_sort - random)')
    plt.xlabel('Input Size (n # elements)')
    plt.ylabel('Elapsed Time (nanoseconds)')

    fit1 = "ss1: " + str(add_to_plot('shell_sort1',PermutationType.UNIFORMLY_DISTRIBUTED,5))
    fit2 = "ss2: " + str(add_to_plot('shell_sort2',PermutationType.UNIFORMLY_DISTRIBUTED,4))
    fit3 = "ss3: " + str(add_to_plot('shell_sort3',PermutationType.UNIFORMLY_DISTRIBUTED,4))
    fit4 = "ss4: " + str(add_to_plot('shell_sort3',PermutationType.UNIFORMLY_DISTRIBUTED,4))

    plt.legend([fit1,fit2,fit3,fit4])
