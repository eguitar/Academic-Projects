...
if __name__ == '__main__':
    ...
    plt.title('Elapsed Time vs. Input Size (hybrid_sort - reverse)')
    plt.xlabel('Input Size (n # elements)')
    plt.ylabel('Elapsed Time (nanoseconds)')

    fit1 = "hs1: " + str(add_to_plot('hybrid_sort1',PermutationType.REVERSE_SORTED,3))
    fit2 = "hs2: " + str(add_to_plot('hybrid_sort2',PermutationType.REVERSE_SORTED,3))
    fit3 = "hs3: " + str(add_to_plot('hybrid_sort3',PermutationType.REVERSE_SORTED,3))
