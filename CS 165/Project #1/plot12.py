...
if __name__ == '__main__':
    ...
    plt.title('Elapsed Time vs. Input Size (insertion_sort / merge_sort - reverse)')
    plt.xlabel('Input Size (n # elements)')
    plt.ylabel('Elapsed Time (nanoseconds)')

    fit1 = "is1: " + str(add_to_plot('insertion_sort',PermutationType.REVERSE_SORTED,0))
    fit2 = "ms2: " + str(add_to_plot('merge_sort',PermutationType.REVERSE_SORTED,3))
